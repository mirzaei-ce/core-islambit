...
This document provides guidelines for internationalization of the Islambit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `islambit_en.ts` remains unchanged.
