Islambit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/islambit/files/Islambit/islambit-0.5.4/
...
http://gitorious.org/islambit/islambitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Islambit-Qt notifications under Growl 1.3.
Increase required age of Islambit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIslambit properly when installing Islambit-Qt over it. (Windows)
