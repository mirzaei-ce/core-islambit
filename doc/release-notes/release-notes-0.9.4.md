Islambit Core version 0.9.4 is now available from:

  https://islambit.org/bin/0.9.4/
...
this update is incompatible with the Islambit system and could lead to consensus
forks.

Islambit Core released binaries from https://islambit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~islambit/+archive/ubuntu/islambit
- A third-party or self-compiled Islambit Core

upgrade to Islambit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
