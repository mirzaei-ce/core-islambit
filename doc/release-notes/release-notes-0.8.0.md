Islambit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/islambit/files/Islambit/islambit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Islambit
...
New/changed settings (command-line or islambit.conf file)
--------------------------------------------------------
