...
unlocked to sign the Islambit-Qt.app bundle.
...
allowing somebody to distribute a Islambit-Qt.app or islambit-qt-setup.exe with a valid
...
that the islambit-qt.exe file inside the installer had not been tampered with.
