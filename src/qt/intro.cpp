...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/islambit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Islambit Core"),
     ...
     * override -datadir in the islambit.conf file in the default data directory
     * (to be consistent with islambitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
