...
#ifndef ISLAMBIT_QT_ISLAMBITUNITS_H
#define ISLAMBIT_QT_ISLAMBITUNITS_H
...
/** Islambit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IslambitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IslambitUnits(QObject *parent);

    /** Islambit units.
      @note Source: https://en.islambit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IBT,
...
typedef IslambitUnits::Unit IslambitUnit;

#endif // ISLAMBIT_QT_ISLAMBITUNITS_H
