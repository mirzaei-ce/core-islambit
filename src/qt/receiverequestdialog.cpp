...
#include "config/islambit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatIslambitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + IslambitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatIslambitURI(info));
}
