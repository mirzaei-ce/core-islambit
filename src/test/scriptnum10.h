...
#ifndef ISLAMBIT_TEST_SCRIPTNUM10_H
#define ISLAMBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Islambit Core 0.10.0, for cross-comparison.
 */
public:
