...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CIslambitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CIslambitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CIslambitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CIslambitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CIslambitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CIslambitAddress(arr[0].get_str()).Get() == demoAddress.Get());
